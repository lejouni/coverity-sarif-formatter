...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Coverity Sarif Formatter"
    )
    #Parse commandline arguments
    parser.add_argument('--url', help="Coverity URL.", default="", required=True)
    ...
    logging.info("Coverity Results to Sarif version: " + __versionro__)
